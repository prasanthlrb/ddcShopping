				...
				<div class="animated_item">
					...
					<div class="sw_section bg_images">
						...
						<div class="wrapper">
							...
							<button class="change_bg" data-src="{{ asset('images/image_bg_1.jpg')}}"></button>
							<button class="change_bg" data-src="{{ asset('images/image_bg_2.jpg')}}"></button>
								...
								<div class="col-lg-3 col-sm-4">
									...
									<div class="clearfix">
										...
										<div class="alignright site_settings">
											...
											<span class="current open_"><img src="{{ asset('images/flag_en.jpg')}}" alt="">English</span>
										...
										<div class="shopping_cart dropdown">
												...
												<div class="animated_item">
													...
													<div class="clearfix sc_product">
														...
														<a href="#" class="product_thumb"><img src="{{ asset('images/sc_img_1.jpg')}}" alt=""></a>
												...
												<div class="animated_item">
													...
													<div class="clearfix sc_product">
														...
														<a href="#" class="product_thumb"><img src="{{ asset('images/sc_img_2.jpg')}}" alt=""></a>
												...
												<div class="animated_item">
													...
													<div class="clearfix sc_product">
														...
														<a href="#" class="product_thumb"><img src="{{ asset('images/sc_img_3.jpg')}}" alt=""></a>
									...
									<ul class="products_list_widget">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod1.jpg')}}" alt="">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod2.jpg')}}" alt="">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod3.jpg')}}" alt="">
									...
									<ul class="products_list_widget">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod4.jpg')}}" alt="">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod5.jpg')}}" alt="">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod6.jpg')}}" alt="">
									...
									<ul class="products_list_widget">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod7.jpg')}}" alt="">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod8.jpg')}}" alt="">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod9.jpg')}}" alt="">
									...
									<ul class="products_list_widget">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod10.jpg')}}" alt="">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod11.jpg')}}" alt="">
										...
										<li>
											...
											<a href="#" class="product_thumb">
												...
												<img src="{{ asset('images/83x83_prod12.jpg')}}" alt="">
				...
				<div class="footer_section_3 align_center">
					...
					<div class="container">
						...
						<ul class="payments">
							...
							<li><img src="{{ asset('images/payment_1.png')}}" alt=""></li>
							<li><img src="{{ asset('images/payment_2.png')}}" alt=""></li>
							<li><img src="{{ asset('images/payment_3.png')}}" alt=""></li>
							<li><img src="{{ asset('images/payment_4.png')}}" alt=""></li>
							<li><img src="{{ asset('images/payment_5.png')}}" alt=""></li>
							<li><img src="{{ asset('images/payment_6.png')}}" alt=""></li>
							<li><img src="{{ asset('images/payment_7.png')}}" alt=""></li>
							<li><img src="{{ asset('images/payment_8.png')}}" alt=""></li>
