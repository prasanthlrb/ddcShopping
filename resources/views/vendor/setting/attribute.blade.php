              ...
              <table class="table table-striped table-bordered zero-configuration">
                ...
                @php $x++ @endphp
                  <tr>
                    ...
                    <td class="text-center"><a href="/vendor/terms/{{$row->id}}"><i class="ft-bookmark"></i>
                      <?php $x=0;?>
