        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img class="brand-logo" alt="modern admin logo" src="{{ asset('images/logo.png')}}">
              {{--  <h3 class="brand-text">DDC</h3>  --}}
            </a>
          </li>
  ...
  <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="index.html"><i class="la ft-briefcase"></i><span class="menu-title" data-i18n="nav.dash.main">Products</span></a>
         
        </li>
        <li class=" nav-item"><a href="index.html"><i class="la ft-shopping-cart"></i><span class="menu-title" data-i18n="nav.dash.main">Orders</span></a>
         
        </li>
        <li class=" nav-item"><a href="index.html"><i class="la la-gift"></i><span class="menu-title" data-i18n="nav.dash.main">Coupons</span></a>
         
        </li>
        <li class=" nav-item"><a href="index.html"><i class="la la-pie-chart"></i><span class="menu-title" data-i18n="nav.dash.main">Reports</span></a>
         
        </li>
        <li class=" nav-item"><a href="index.html"><i class="la la-comment"></i><span class="menu-title" data-i18n="nav.dash.main">Reviews</span></a>
         
        </li>
        <li class=" nav-item"><a href="index.html"><i class="la la-download"></i><span class="menu-title" data-i18n="nav.dash.main">Withdraw</span></a>
        ...
        <li class=" nav-item"><a href="index.html"><i class="la la-support"></i><span class="menu-title" data-i18n="nav.dash.main">Supports</span></a>
         
        </li>
        
       
       
        <li class=" nav-item"><a href="#"><i class="la la-cog"></i><span class="menu-title" data-i18n="nav.flot_charts.main">Setting</span></a>
