                  ...
                  <div class="col-12">
                    ...
                    <div class="card">
                      <div class="card-header">
                            ...
                            <button data-target="#primary" data-backdrop="false" class="btn btn-success round btn-glow px-2" data-toggle="modal">Create Role</button>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput1" class="form-control" placeholder="Employee Id"
                          name="fname">
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput1" class="form-control" placeholder="Email"
                          name="fname">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <select id="projectinput6" name="interested" class="form-control">
                            ...
                            <option value="development">Deactive</option>
