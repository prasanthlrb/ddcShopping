...
data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="nav-item"><a href="/admin/contact"><i class="la la-user"></i><span class="menu-title">Contacts</span><span class="float-right mr-2"><i class="la la-plus" id="add-contact"></i></span></a>
          
        </li>


        <li class="nav-item"><a href="index.html"><i class="la la-user-plus"></i><span class="menu-title">User</span></a>
        ...
        <li class="nav-item"><a href="index.html"><i class="la la-user-plus"></i><span class="menu-title">Vendor</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="/admin/viewVendor" data-i18n="nav.dash.ecommerce">Vendor List</a>
            </li>
           
          </ul>
        </li>

        <li class="nav-item"><a href="/admin/newsletter"><i class="la la-user"></i><span class="menu-title">News Letter</span><span class="float-right mr-2"><i class="la la-plus" id="add-contact"></i></span></a>
          
          </li>

        <li class=" nav-item"><a href="index.html"><i class="icon-handbag"></i><span class="menu-title">Products</span></a>
          <ul class="menu-content">
        ...
        <li class=" nav-item"><a href="index.html"><i class="ft-shopping-cart"></i><span class="menu-title">Order</span><span class="badge badge badge-info badge-pill float-right mr-2">3</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="dashboard-ecommerce.html" data-i18n="nav.dash.ecommerce">Orders</a>
            </li>
            <li><a class="menu-item" href="/admin/coupon/">Coupons</a>
            </li>
        ...
        <li><a href="#"><i class="ft-align-left"></i> CMS</a>
          <ul>
            ...
            <li><a href="#"><i class="la la-file-o"></i> Home Page</a>
              <ul>
                <li><a class="menu-item" href="#">  Sliders</a></li>
                <li><a class="menu-item" href="#">Today Deals</a></li>
                ...
                <li><a class="menu-item" href="#">Ads</a></li>
              </ul>
            </li>
            <li><a class="menu-item" href="#"><i class="la la-hdd-o"></i> Terms</a></li>
            <li><a class="menu-item" href="#"><i class="la la-floppy-o"></i> Shipping Details</a></li>
          </ul>
        </li>
        <li class=" nav-item"><a href="index.html"><i class="la la-gear"></i><span class="menu-title">Settings</span></a>
          <ul class="menu-content">
            <li>
  ...
  <footer class="footer footer-static footer-light navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 20<?=date('y')?> <a class="text-bold-800 grey darken-2" href="javascript:void(null)">DDC UAE </a>, All rights reserved. </span>
