      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
                ...
                <button data-target="#primary" data-backdrop="false" class="btn btn-success round btn-glow px-2" data-toggle="modal">Create FAQ</button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input type="text" id="projectinput1" class="form-control" placeholder="Enter your question"
              name="question">
            </div>
          </div>
          <div class="form-group row">
                <label class="col-md-3 label-control" for="projectinput11">Answer</label>
                <div class="col-md-9">
                  <textarea id="projectinput11" rows="5" class="form-control" name="answer" placeholder="Enter your answer"></textarea>
                </div>
              </div>
        </div>
