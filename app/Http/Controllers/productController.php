...
class productController extends Controller
{
    ...
    public function viewSubCategory($id){
        ...
        return view('admin/setting/subCategory',compact('subCategory'));
    ...
    public function viewAttribute(){
        ...
        $terms = terms::all();
        return view('admin/setting/attribute',compact('attribute','terms'));
    }
    ...
    public function viewTerms($id){
        $terms  = DB::table('terms')
           ...
           ->get();
        $attribute = attribute::find($id);
        return view('admin/setting/terms',compact('attribute','terms'));    
        //return response()->json( $attribute);   
    }
    ...
    public function viewProduct(){
        ...
        $subCategory = subCategory::all();
        $product = product::all();
        return view('admin/setting/viewProduct',compact('category','subCategory','product'));
    }
    ...
    public function addProduct(){
        ...
        $brand = brand::all();
        $tag = tag::all();
        return view('admin/setting/addProduct',compact('brand','Vendor','product','category','attribute','tag'));
    }
